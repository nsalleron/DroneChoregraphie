 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.idm_project.impl.RefPourcentVarImpl#getVar <em>Var</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RefPourcentVarImpl extends PourcentExpImpl implements RefPourcentVar
{
  ...
  {
    return Idm_projectPackage.Literals.REF_POURCENT_VAR;
  }
    ...
    if (var != null && var.eIsProxy())
    {
      ...
      if (var != oldVar)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, Idm_projectPackage.REF_POURCENT_VAR__VAR, oldVar, var));
      }
    }
    return var;
  }
  ...
  public void setVar(PourcentDecl newVar)
  {
    ...
    var = newVar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Idm_projectPackage.REF_POURCENT_VAR__VAR, oldVar, var));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Idm_projectPackage.REF_POURCENT_VAR__VAR:
