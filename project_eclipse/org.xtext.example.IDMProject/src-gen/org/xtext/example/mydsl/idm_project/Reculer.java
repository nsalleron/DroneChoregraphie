 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.idm_project.Reculer#getDuree <em>Duree</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.idm_project.Reculer#getVitesse_deplacement <em>Vitesse deplacement</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.idm_project.Idm_projectPackage#getReculer()
 * @model
 * @generated
 */
public interface Reculer extends Statement, AR
{
   ...
   * @see #setDuree(IntExp)
   * @see org.xtext.example.mydsl.idm_project.Idm_projectPackage#getReculer_Duree()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.idm_project.Reculer#getDuree <em>Duree</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.idm_project.Idm_projectPackage#getReculer_Vitesse_deplacement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.idm_project.Reculer#getVitesse_deplacement <em>Vitesse deplacement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
