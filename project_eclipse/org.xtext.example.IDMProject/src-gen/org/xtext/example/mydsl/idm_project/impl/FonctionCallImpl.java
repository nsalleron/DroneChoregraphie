 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.idm_project.impl.FonctionCallImpl#getFunc <em>Func</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FonctionCallImpl extends MinimalEObjectImpl.Container implements FonctionCall
{
  ...
  {
    return Idm_projectPackage.Literals.FONCTION_CALL;
  }
    ...
    if (func != null && func.eIsProxy())
    {
      ...
      if (func != oldFunc)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, Idm_projectPackage.FONCTION_CALL__FUNC, oldFunc, func));
      }
    }
    return func;
  }
  ...
  public void setFunc(FonctionDecl newFunc)
  {
    ...
    func = newFunc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Idm_projectPackage.FONCTION_CALL__FUNC, oldFunc, func));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Idm_projectPackage.FONCTION_CALL__FUNC:
