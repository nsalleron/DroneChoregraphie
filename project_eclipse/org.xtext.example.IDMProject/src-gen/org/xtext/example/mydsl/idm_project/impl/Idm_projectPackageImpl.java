...
import org.xtext.example.mydsl.idm_project.Idm_projectFactory;
 ...
 * @generated
 */
public class Idm_projectPackageImpl extends EPackageImpl implements Idm_projectPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.idm_project.Idm_projectPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private Idm_projectPackageImpl()
  {
    super(eNS_URI, Idm_projectFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link Idm_projectPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static Idm_projectPackage init()
  {
    if (isInited) return (Idm_projectPackage)EPackage.Registry.INSTANCE.getEPackage(Idm_projectPackage.eNS_URI);

    // Obtain or create and register package
    Idm_projectPackageImpl theIdm_projectPackage = (Idm_projectPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Idm_projectPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Idm_projectPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theIdm_projectPackage.createPackageContents();

    // Initialize created meta-data
    theIdm_projectPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theIdm_projectPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(Idm_projectPackage.eNS_URI, theIdm_projectPackage);
    return theIdm_projectPackage;
  }
   ...
   * @generated
   */
  public Idm_projectFactory getIdm_projectFactory()
  {
    return (Idm_projectFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(mdEClass, org.xtext.example.mydsl.idm_project.MD.class, "MD", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(gDrEClass, GDr.class, "GDr", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(rgrdEClass, org.xtext.example.mydsl.idm_project.RGRD.class, "RGRD", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(arEClass, org.xtext.example.mydsl.idm_project.AR.class, "AR", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
