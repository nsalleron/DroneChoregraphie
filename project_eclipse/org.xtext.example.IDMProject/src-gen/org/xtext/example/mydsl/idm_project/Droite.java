 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.idm_project.Droite#getDuree <em>Duree</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.idm_project.Droite#getVitesse_deplacement <em>Vitesse deplacement</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.idm_project.Idm_projectPackage#getDroite()
 * @model
 * @generated
 */
public interface Droite extends Statement, GDr
{
   ...
   * @see #setDuree(IntExp)
   * @see org.xtext.example.mydsl.idm_project.Idm_projectPackage#getDroite_Duree()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.idm_project.Droite#getDuree <em>Duree</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.idm_project.Idm_projectPackage#getDroite_Vitesse_deplacement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.idm_project.Droite#getVitesse_deplacement <em>Vitesse deplacement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
