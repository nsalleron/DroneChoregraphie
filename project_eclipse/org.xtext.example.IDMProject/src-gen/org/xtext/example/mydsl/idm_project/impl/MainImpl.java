 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.idm_project.impl.MainImpl#getSeconDec <em>Secon Dec</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.idm_project.impl.MainImpl#getPourDec <em>Pour Dec</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.idm_project.impl.MainImpl#getStatements <em>Statements</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.idm_project.impl.MainImpl#getFonctions <em>Fonctions</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.idm_project.impl.MainImpl#getParallele <em>Parallele</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MainImpl extends MinimalEObjectImpl.Container implements Main
{
  ...
  {
    return Idm_projectPackage.Literals.MAIN;
  }
  ...
  public EList<IntDecl> getSeconDec()
  {
    if (seconDec == null)
    {
      seconDec = new EObjectContainmentEList<IntDecl>(IntDecl.class, this, Idm_projectPackage.MAIN__SECON_DEC);
    }
    return seconDec;
  }
  ...
  public EList<PourcentDecl> getPourDec()
  {
    if (pourDec == null)
    {
      pourDec = new EObjectContainmentEList<PourcentDecl>(PourcentDecl.class, this, Idm_projectPackage.MAIN__POUR_DEC);
    }
    return pourDec;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, Idm_projectPackage.MAIN__STATEMENTS);
    }
    return statements;
  }
  ...
  public EList<FonctionCall> getFonctions()
  {
    if (fonctions == null)
    {
      fonctions = new EObjectContainmentEList<FonctionCall>(FonctionCall.class, this, Idm_projectPackage.MAIN__FONCTIONS);
    }
    return fonctions;
  }
  ...
  public EList<EObject> getParallele()
  {
    if (parallele == null)
    {
      parallele = new EObjectContainmentEList<EObject>(EObject.class, this, Idm_projectPackage.MAIN__PARALLELE);
    }
    return parallele;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Idm_projectPackage.MAIN__SECON_DEC:
        return ((InternalEList<?>)getSeconDec()).basicRemove(otherEnd, msgs);
      case Idm_projectPackage.MAIN__POUR_DEC:
        return ((InternalEList<?>)getPourDec()).basicRemove(otherEnd, msgs);
      case Idm_projectPackage.MAIN__STATEMENTS:
        return ((InternalEList<?>)getStatements()).basicRemove(otherEnd, msgs);
      case Idm_projectPackage.MAIN__FONCTIONS:
        return ((InternalEList<?>)getFonctions()).basicRemove(otherEnd, msgs);
      case Idm_projectPackage.MAIN__PARALLELE:
