...
public class InternalMyTurtleDslLexer extends Lexer {
    ...
    public final void mRULE_POURCENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyTurtleDsl.g:4406:15: ( ( '1' .. '9' | '1' .. '9' '0' .. '9' | '100' ) '%' )
            // InternalMyTurtleDsl.g:4406:17: ( '1' .. '9' | '1' .. '9' '0' .. '9' | '100' ) '%'
            {
            // InternalMyTurtleDsl.g:4406:17: ( '1' .. '9' | '1' .. '9' '0' .. '9' | '100' )
            int alt1=3;
            ...
            switch (alt1) {
                case 1 :
                    // InternalMyTurtleDsl.g:4406:18: '1' .. '9'
                    {
                    matchRange('1','9'); 
                    ...
                    break;
                case 2 :
                    // InternalMyTurtleDsl.g:4406:27: '1' .. '9' '0' .. '9'
                    {
                    matchRange('1','9'); 
                    matchRange('0','9'); 
                    ...
                    break;
                case 3 :
                    // InternalMyTurtleDsl.g:4406:45: '100'
                    {
                    match("100"); 
    ...
    public final void mRULE_INCLUDE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyTurtleDsl.g:4408:14: ( RULE_ID '.drone' )
            // InternalMyTurtleDsl.g:4408:16: RULE_ID '.drone'
            {
            mRULE_ID(); 
            match(".drone"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyTurtleDsl.g:4410:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMyTurtleDsl.g:4410:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMyTurtleDsl.g:4410:11: ( '^' )?
            int alt2=2;
            ...
            // InternalMyTurtleDsl.g:4410:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyTurtleDsl.g:4412:10: ( ( '0' .. '9' )+ )
            // InternalMyTurtleDsl.g:4412:12: ( '0' .. '9' )+
            {
            // InternalMyTurtleDsl.g:4412:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
            do {
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalMyTurtleDsl.g:4412:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyTurtleDsl.g:4414:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMyTurtleDsl.g:4414:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMyTurtleDsl.g:4414:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalMyTurtleDsl.g:4414:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMyTurtleDsl.g:4414:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                    ...
                    break;
                case 2 :
                    // InternalMyTurtleDsl.g:4414:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMyTurtleDsl.g:4414:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyTurtleDsl.g:4416:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMyTurtleDsl.g:4416:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMyTurtleDsl.g:4416:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyTurtleDsl.g:4418:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMyTurtleDsl.g:4418:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMyTurtleDsl.g:4418:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
            ...
            // InternalMyTurtleDsl.g:4418:40: ( ( '\\r' )? '\\n' )?
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalMyTurtleDsl.g:4418:41: ( '\\r' )? '\\n'
                    {
                    // InternalMyTurtleDsl.g:4418:41: ( '\\r' )?
                    int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyTurtleDsl.g:4420:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMyTurtleDsl.g:4420:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMyTurtleDsl.g:4420:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyTurtleDsl.g:4422:16: ( . )
            // InternalMyTurtleDsl.g:4422:18: .
            {
            matchAny(); 
