 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myTurtleDsl.impl.Pourcent_vitesse_deplacement_maxImpl#getVitesse_deplacement <em>Vitesse deplacement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pourcent_vitesse_deplacement_maxImpl extends MinimalEObjectImpl.Container implements Pourcent_vitesse_deplacement_max
{
  ...
  {
    return MyTurtleDslPackage.Literals.POURCENT_VITESSE_DEPLACEMENT_MAX;
  }
  ...
  public NotificationChain basicSetVitesse_deplacement(PourcentConst newVitesse_deplacement, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyTurtleDslPackage.POURCENT_VITESSE_DEPLACEMENT_MAX__VITESSE_DEPLACEMENT, oldVitesse_deplacement, newVitesse_deplacement);
  ...
  public void setVitesse_deplacement(PourcentConst newVitesse_deplacement)
  {
    if (newVitesse_deplacement != vitesse_deplacement)
    {
      ...
      if (vitesse_deplacement != null)
        msgs = ((InternalEObject)vitesse_deplacement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyTurtleDslPackage.POURCENT_VITESSE_DEPLACEMENT_MAX__VITESSE_DEPLACEMENT, null, msgs);
      if (newVitesse_deplacement != null)
        msgs = ((InternalEObject)newVitesse_deplacement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyTurtleDslPackage.POURCENT_VITESSE_DEPLACEMENT_MAX__VITESSE_DEPLACEMENT, null, msgs);
      msgs = basicSetVitesse_deplacement(newVitesse_deplacement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyTurtleDslPackage.POURCENT_VITESSE_DEPLACEMENT_MAX__VITESSE_DEPLACEMENT, newVitesse_deplacement, newVitesse_deplacement));
  }
