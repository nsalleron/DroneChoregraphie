...
\section{Prologue}
Nous avons fait le choix de rendre obligatoire la définition de certaines constantes de vol.
\subsection{define vitesse\_hauteur\_max}
Ce define permet de définir la vitesse maximale du drone pendant la chorégraphie par rapport à sa vitesse maximale.
\subsection{define vitesse\_deplacement\_max}
Ce define permet de définir la vitesse maximale de déplacement sur le plan horizontal du drone pendant la chorégraphie par rapport à sa vitesse maximale.
\subsection{define vitesse\_rotation\_max}
Ce define permet de définir la vitesse maximale de rotation du drone sur le plan horizontal du drone pendant la chorégraphie par rapport à sa vitesse maximale.
\subsection{define hauteur\_max}
Ce define permet de limiter l'altitude maximale du drone en vol. Lorsque le drone est sur le point de dépasser cette limite, il se stabilise automatiquement à la hauteur.
\subsection{define eloignement\_max}
Ce define permet de contrôler la distance du drone en vol. Lorsque le drone est sur le point de dépasser cette limite, un message d'alarme s'affiche sur votre smartphone.
...
Le paramètre \textbf{vitesse\_vertical} est un pourcentage compris entre 1 et 100. Il indique la vitesse d'élévation du drone par rapport à la vitesse verticale maximum définie par l'utilisateur (c.f 4.1.1). \\
...
Le paramètre \textbf{vitesse\_verticale} est un pourcentage compris entre 1 et 100. Il indique la vitesse de déplacement du drone par rapport à la vitesse horizontale maximum définie par l'utilisateur (c.f 4.1.2). \\
...
Le paramètre \textbf{vitesse\_deplacement} est un entier positif compris entre 1 et 100. Il indique la vitesse de déplacement du drone par rapport à la vitesse horizontale maximum définie par l'utilisateur (c.f 4.1.2). \\
...
Le paramètre \textbf{vitesse\_rotation} est un entier positif compris entre 1 et 100. Il indique la vitesse de déplacement du drone par rapport à la vitesse de rotation maximale définie par l'utilisateur (c.f 4.1.3). \\
...
\subsection{Le point d'entée "main"}
...
Il est possible d'utiliser des fonctions définies dans d'autres programmes .drone, ces fichiers doivent être dans le même répertoire.
...
\chapter{Glossaire}
\paragraph{méta-modèle} la représentation d'un point de vue structurel d'un systeme. Ici c'est la syntaxe du langage de programmation du drone. 
