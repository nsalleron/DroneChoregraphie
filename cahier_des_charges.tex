...
Il est possible d'utiliser des fonctions définies dans d'autres fichiers .drone, ces fichiers doivent être dans le même répertoire que le fichier appelant les fonctions.
