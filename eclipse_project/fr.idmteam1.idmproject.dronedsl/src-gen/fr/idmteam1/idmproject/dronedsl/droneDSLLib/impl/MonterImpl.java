 ...
 * </p>
 * <ul>
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSLLib.impl.MonterImpl#getDuree <em>Duree</em>}</li>
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSLLib.impl.MonterImpl#getVitesse_verticale <em>Vitesse verticale</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MonterImpl extends StatementImpl implements Monter
{
  ...
  {
    return DroneDSLLibPackage.Literals.MONTER;
  }
  ...
  public NotificationChain basicSetDuree(IntExp newDuree, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroneDSLLibPackage.MONTER__DUREE, oldDuree, newDuree);
  ...
  public void setDuree(IntExp newDuree)
  {
    if (newDuree != duree)
    {
      ...
      if (duree != null)
        msgs = ((InternalEObject)duree).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroneDSLLibPackage.MONTER__DUREE, null, msgs);
      if (newDuree != null)
        msgs = ((InternalEObject)newDuree).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroneDSLLibPackage.MONTER__DUREE, null, msgs);
      msgs = basicSetDuree(newDuree, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneDSLLibPackage.MONTER__DUREE, newDuree, newDuree));
  }
  ...
  public NotificationChain basicSetVitesse_verticale(PourcentExp newVitesse_verticale, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroneDSLLibPackage.MONTER__VITESSE_VERTICALE, oldVitesse_verticale, newVitesse_verticale);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setVitesse_verticale(PourcentExp newVitesse_verticale)
  {
    if (newVitesse_verticale != vitesse_verticale)
    {
      ...
      if (vitesse_verticale != null)
        msgs = ((InternalEObject)vitesse_verticale).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroneDSLLibPackage.MONTER__VITESSE_VERTICALE, null, msgs);
      if (newVitesse_verticale != null)
        msgs = ((InternalEObject)newVitesse_verticale).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroneDSLLibPackage.MONTER__VITESSE_VERTICALE, null, msgs);
      msgs = basicSetVitesse_verticale(newVitesse_verticale, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneDSLLibPackage.MONTER__VITESSE_VERTICALE, newVitesse_verticale, newVitesse_verticale));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DroneDSLLibPackage.MONTER__DUREE:
        return basicSetDuree(null, msgs);
      case DroneDSLLibPackage.MONTER__VITESSE_VERTICALE:
