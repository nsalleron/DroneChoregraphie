 ...
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSLLib.RotationDroite#getVitesse <em>Vitesse</em>}</li>
 * </ul>
 *
...
public interface RotationDroite extends Mouvement, CommandeBasique, RGRD
{
   ...
   * @see fr.idmteam1.idmproject.dronedsl.droneDSLLib.DroneDSLLibPackage#getRotationDroite_Vitesse()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.idmteam1.idmproject.dronedsl.droneDSLLib.RotationDroite#getVitesse <em>Vitesse</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
