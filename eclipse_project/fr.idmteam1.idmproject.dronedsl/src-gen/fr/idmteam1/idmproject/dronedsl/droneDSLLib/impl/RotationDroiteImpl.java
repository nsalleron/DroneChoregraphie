 ...
 * </p>
 * <ul>
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSLLib.impl.RotationDroiteImpl#getDuree <em>Duree</em>}</li>
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSLLib.impl.RotationDroiteImpl#getVitesse_rotation <em>Vitesse rotation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RotationDroiteImpl extends StatementImpl implements RotationDroite
{
  ...
  {
    return DroneDSLLibPackage.Literals.ROTATION_DROITE;
  }
  ...
  public NotificationChain basicSetDuree(IntExp newDuree, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroneDSLLibPackage.ROTATION_DROITE__DUREE, oldDuree, newDuree);
  ...
  public void setDuree(IntExp newDuree)
  {
    if (newDuree != duree)
    {
      ...
      if (duree != null)
        msgs = ((InternalEObject)duree).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroneDSLLibPackage.ROTATION_DROITE__DUREE, null, msgs);
      if (newDuree != null)
        msgs = ((InternalEObject)newDuree).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroneDSLLibPackage.ROTATION_DROITE__DUREE, null, msgs);
      msgs = basicSetDuree(newDuree, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneDSLLibPackage.ROTATION_DROITE__DUREE, newDuree, newDuree));
  }
  ...
  public NotificationChain basicSetVitesse_rotation(PourcentExp newVitesse_rotation, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroneDSLLibPackage.ROTATION_DROITE__VITESSE_ROTATION, oldVitesse_rotation, newVitesse_rotation);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setVitesse_rotation(PourcentExp newVitesse_rotation)
  {
    if (newVitesse_rotation != vitesse_rotation)
    {
      ...
      if (vitesse_rotation != null)
        msgs = ((InternalEObject)vitesse_rotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroneDSLLibPackage.ROTATION_DROITE__VITESSE_ROTATION, null, msgs);
      if (newVitesse_rotation != null)
        msgs = ((InternalEObject)newVitesse_rotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroneDSLLibPackage.ROTATION_DROITE__VITESSE_ROTATION, null, msgs);
      msgs = basicSetVitesse_rotation(newVitesse_rotation, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneDSLLibPackage.ROTATION_DROITE__VITESSE_ROTATION, newVitesse_rotation, newVitesse_rotation));
  }
