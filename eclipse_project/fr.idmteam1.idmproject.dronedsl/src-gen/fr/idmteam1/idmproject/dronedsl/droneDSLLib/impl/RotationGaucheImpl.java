...
public class RotationGaucheImpl extends MouvementImpl implements RotationGauche
{
  ...
  {
    return DroneDSLLibPackage.Literals.ROTATION_GAUCHE;
  }
  ...
  public NotificationChain basicSetDuree(SecondeExp newDuree, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroneDSLLibPackage.ROTATION_GAUCHE__DUREE, oldDuree, newDuree);
  ...
  public void setDuree(SecondeExp newDuree)
  {
    if (newDuree != duree)
    {
      ...
      if (duree != null)
        msgs = ((InternalEObject)duree).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroneDSLLibPackage.ROTATION_GAUCHE__DUREE, null, msgs);
      if (newDuree != null)
        msgs = ((InternalEObject)newDuree).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroneDSLLibPackage.ROTATION_GAUCHE__DUREE, null, msgs);
      msgs = basicSetDuree(newDuree, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneDSLLibPackage.ROTATION_GAUCHE__DUREE, newDuree, newDuree));
  }
