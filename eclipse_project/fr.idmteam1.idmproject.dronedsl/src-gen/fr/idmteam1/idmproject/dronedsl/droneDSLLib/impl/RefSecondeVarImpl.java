 ...
 * </p>
 * <ul>
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSLLib.impl.RefSecondeVarImpl#getVar <em>Var</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RefSecondeVarImpl extends SecondeExpImpl implements RefSecondeVar
{
  ...
  {
    return DroneDSLLibPackage.Literals.REF_SECONDE_VAR;
  }
    ...
    if (var != null && var.eIsProxy())
    {
      ...
      if (var != oldVar)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DroneDSLLibPackage.REF_SECONDE_VAR__VAR, oldVar, var));
      }
    }
    return var;
  }
  ...
  public void setVar(SecondeDecl newVar)
  {
    ...
    var = newVar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneDSLLibPackage.REF_SECONDE_VAR__VAR, oldVar, var));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DroneDSLLibPackage.REF_SECONDE_VAR__VAR:
