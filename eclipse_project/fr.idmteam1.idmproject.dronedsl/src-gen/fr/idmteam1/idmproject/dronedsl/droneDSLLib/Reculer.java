 ...
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSLLib.Reculer#getVitesse <em>Vitesse</em>}</li>
 * </ul>
 *
...
public interface Reculer extends Mouvement, CommandeBasique, AR
{
   ...
   * @see fr.idmteam1.idmproject.dronedsl.droneDSLLib.DroneDSLLibPackage#getReculer_Vitesse()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.idmteam1.idmproject.dronedsl.droneDSLLib.Reculer#getVitesse <em>Vitesse</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
