 ...
 * </p>
 * <ul>
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSL.IntDecl#getName <em>Name</em>}</li>
...
public interface IntDecl extends EObject
{
   ...
   * @see #setName(String)
   * @see fr.idmteam1.idmproject.dronedsl.droneDSL.DroneDSLPackage#getIntDecl_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link fr.idmteam1.idmproject.dronedsl.droneDSL.IntDecl#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
