 ...
 * </p>
 * <ul>
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Gauche#getDuree <em>Duree</em>}</li>
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Gauche#getVitesse_deplacement <em>Vitesse deplacement</em>}</li>
 * </ul>
 *
 * @see fr.idmteam1.idmproject.dronedsl.droneDSL.DroneDSLPackage#getGauche()
 * @model
 * @generated
 */
public interface Gauche extends Mouvement, CommandeBasique, GDr
{
   ...
   * @see fr.idmteam1.idmproject.dronedsl.droneDSL.DroneDSLPackage#getGauche_Duree()
  ...
  /**
   * Sets the value of the '{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Gauche#getDuree <em>Duree</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.idmteam1.idmproject.dronedsl.droneDSL.DroneDSLPackage#getGauche_Vitesse_deplacement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Gauche#getVitesse_deplacement <em>Vitesse deplacement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
