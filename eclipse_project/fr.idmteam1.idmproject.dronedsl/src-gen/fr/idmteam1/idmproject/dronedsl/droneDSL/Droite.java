 ...
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Droite#getVitesse <em>Vitesse</em>}</li>
 * </ul>
 *
...
public interface Droite extends Mouvement, CommandeBasique, GDr
{
   ...
   * @see fr.idmteam1.idmproject.dronedsl.droneDSL.DroneDSLPackage#getDroite_Vitesse()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Droite#getVitesse <em>Vitesse</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
