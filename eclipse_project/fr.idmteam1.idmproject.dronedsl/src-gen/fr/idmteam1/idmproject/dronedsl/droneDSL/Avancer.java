 ...
 * </p>
 * <ul>
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Avancer#getDuree <em>Duree</em>}</li>
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Avancer#getVitesse_deplacement <em>Vitesse deplacement</em>}</li>
 * </ul>
 *
 * @see fr.idmteam1.idmproject.dronedsl.droneDSL.DroneDSLPackage#getAvancer()
 * @model
 * @generated
 */
public interface Avancer extends Statement, AR
{
   ...
   * @see #setDuree(IntExp)
   * @see fr.idmteam1.idmproject.dronedsl.droneDSL.DroneDSLPackage#getAvancer_Duree()
  ...
  /**
   * Sets the value of the '{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Avancer#getDuree <em>Duree</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.idmteam1.idmproject.dronedsl.droneDSL.DroneDSLPackage#getAvancer_Vitesse_deplacement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Avancer#getVitesse_deplacement <em>Vitesse deplacement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
