 ...
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Avancer#getVitesse <em>Vitesse</em>}</li>
 * </ul>
 *
...
public interface Avancer extends Mouvement, CommandeBasique, AR
{
   ...
   * @see fr.idmteam1.idmproject.dronedsl.droneDSL.DroneDSLPackage#getAvancer_Vitesse()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.idmteam1.idmproject.dronedsl.droneDSL.Avancer#getVitesse <em>Vitesse</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
