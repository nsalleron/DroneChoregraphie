...
public class Parallele3Impl extends ParalleleImpl implements Parallele3
{
  ...
  public NotificationChain basicSetC(EObject newC, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroneDSLPackage.PARALLELE3__C, oldC, newC);
  ...
  public void setC(EObject newC)
  {
    if (newC != c)
    {
      ...
      if (c != null)
        msgs = ((InternalEObject)c).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroneDSLPackage.PARALLELE3__C, null, msgs);
      if (newC != null)
        msgs = ((InternalEObject)newC).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroneDSLPackage.PARALLELE3__C, null, msgs);
      msgs = basicSetC(newC, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneDSLPackage.PARALLELE3__C, newC, newC));
  }
