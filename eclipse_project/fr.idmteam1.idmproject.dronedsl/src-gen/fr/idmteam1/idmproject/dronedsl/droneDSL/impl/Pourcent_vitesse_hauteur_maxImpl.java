 ...
 * </p>
 * <ul>
 *   <li>{@link fr.idmteam1.idmproject.dronedsl.droneDSL.impl.Pourcent_vitesse_hauteur_maxImpl#getVitesse_verticale <em>Vitesse verticale</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pourcent_vitesse_hauteur_maxImpl extends MinimalEObjectImpl.Container implements Pourcent_vitesse_hauteur_max
{
  ...
  {
    return DroneDSLPackage.Literals.POURCENT_VITESSE_HAUTEUR_MAX;
  }
  ...
  public NotificationChain basicSetVitesse_verticale(PourcentConst newVitesse_verticale, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroneDSLPackage.POURCENT_VITESSE_HAUTEUR_MAX__VITESSE_VERTICALE, oldVitesse_verticale, newVitesse_verticale);
  ...
  public void setVitesse_verticale(PourcentConst newVitesse_verticale)
  {
    if (newVitesse_verticale != vitesse_verticale)
    {
      ...
      if (vitesse_verticale != null)
        msgs = ((InternalEObject)vitesse_verticale).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroneDSLPackage.POURCENT_VITESSE_HAUTEUR_MAX__VITESSE_VERTICALE, null, msgs);
      if (newVitesse_verticale != null)
        msgs = ((InternalEObject)newVitesse_verticale).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroneDSLPackage.POURCENT_VITESSE_HAUTEUR_MAX__VITESSE_VERTICALE, null, msgs);
      msgs = basicSetVitesse_verticale(newVitesse_verticale, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneDSLPackage.POURCENT_VITESSE_HAUTEUR_MAX__VITESSE_VERTICALE, newVitesse_verticale, newVitesse_verticale));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DroneDSLPackage.POURCENT_VITESSE_HAUTEUR_MAX__VITESSE_VERTICALE:
