 ...
 * </p>
 * <ul>
 *   <li>{@link org.roboticiens.idmProject.droneMain.impl.Pourcent_vitesse_rotation_maxImpl#getVitesse_deplacement <em>Vitesse deplacement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Pourcent_vitesse_rotation_maxImpl extends MinimalEObjectImpl.Container implements Pourcent_vitesse_rotation_max
{
  ...
  {
    return DroneMainPackage.Literals.POURCENT_VITESSE_ROTATION_MAX;
  }
  ...
  public NotificationChain basicSetVitesse_deplacement(PourcentConst newVitesse_deplacement, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroneMainPackage.POURCENT_VITESSE_ROTATION_MAX__VITESSE_DEPLACEMENT, oldVitesse_deplacement, newVitesse_deplacement);
  ...
  public void setVitesse_deplacement(PourcentConst newVitesse_deplacement)
  {
    if (newVitesse_deplacement != vitesse_deplacement)
    {
      ...
      if (vitesse_deplacement != null)
        msgs = ((InternalEObject)vitesse_deplacement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroneMainPackage.POURCENT_VITESSE_ROTATION_MAX__VITESSE_DEPLACEMENT, null, msgs);
      if (newVitesse_deplacement != null)
        msgs = ((InternalEObject)newVitesse_deplacement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroneMainPackage.POURCENT_VITESSE_ROTATION_MAX__VITESSE_DEPLACEMENT, null, msgs);
      msgs = basicSetVitesse_deplacement(newVitesse_deplacement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneMainPackage.POURCENT_VITESSE_ROTATION_MAX__VITESSE_DEPLACEMENT, newVitesse_deplacement, newVitesse_deplacement));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DroneMainPackage.POURCENT_VITESSE_ROTATION_MAX__VITESSE_DEPLACEMENT:
