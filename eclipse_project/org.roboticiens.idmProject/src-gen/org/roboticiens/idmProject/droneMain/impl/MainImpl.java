 ...
 * </p>
 * <ul>
 *   <li>{@link org.roboticiens.idmProject.droneMain.impl.MainImpl#getSeconDec <em>Secon Dec</em>}</li>
 *   <li>{@link org.roboticiens.idmProject.droneMain.impl.MainImpl#getPourDec <em>Pour Dec</em>}</li>
 *   <li>{@link org.roboticiens.idmProject.droneMain.impl.MainImpl#getStatements <em>Statements</em>}</li>
 *   <li>{@link org.roboticiens.idmProject.droneMain.impl.MainImpl#getFonctions <em>Fonctions</em>}</li>
 *   <li>{@link org.roboticiens.idmProject.droneMain.impl.MainImpl#getParallele <em>Parallele</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MainImpl extends MinimalEObjectImpl.Container implements Main
{
  ...
  {
    return DroneMainPackage.Literals.MAIN;
  }
  ...
  public EList<IntDecl> getSeconDec()
  {
    if (seconDec == null)
    {
      seconDec = new EObjectContainmentEList<IntDecl>(IntDecl.class, this, DroneMainPackage.MAIN__SECON_DEC);
    }
    return seconDec;
  }
  ...
  public EList<PourcentDecl> getPourDec()
  {
    if (pourDec == null)
    {
      pourDec = new EObjectContainmentEList<PourcentDecl>(PourcentDecl.class, this, DroneMainPackage.MAIN__POUR_DEC);
    }
    return pourDec;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, DroneMainPackage.MAIN__STATEMENTS);
    }
    return statements;
  }
  ...
  public EList<FonctionCall> getFonctions()
  {
    if (fonctions == null)
    {
      fonctions = new EObjectContainmentEList<FonctionCall>(FonctionCall.class, this, DroneMainPackage.MAIN__FONCTIONS);
    }
    return fonctions;
  }
  ...
  public EList<EObject> getParallele()
  {
    if (parallele == null)
    {
      parallele = new EObjectContainmentEList<EObject>(EObject.class, this, DroneMainPackage.MAIN__PARALLELE);
    }
    return parallele;
  }
