...
import org.roboticiens.idmProject.droneMain.DroneMainFactory;
...
import org.roboticiens.idmProject.droneMain.Statement;
 ...
 * @generated
 */
public class DroneMainPackageImpl extends EPackageImpl implements DroneMainPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.roboticiens.idmProject.droneMain.DroneMainPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private DroneMainPackageImpl()
  {
    super(eNS_URI, DroneMainFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link DroneMainPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static DroneMainPackage init()
  {
    if (isInited) return (DroneMainPackage)EPackage.Registry.INSTANCE.getEPackage(DroneMainPackage.eNS_URI);

    // Obtain or create and register package
    DroneMainPackageImpl theDroneMainPackage = (DroneMainPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DroneMainPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DroneMainPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theDroneMainPackage.createPackageContents();

    // Initialize created meta-data
    theDroneMainPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theDroneMainPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(DroneMainPackage.eNS_URI, theDroneMainPackage);
    return theDroneMainPackage;
  }
   ...
   * @generated
   */
  public DroneMainFactory getDroneMainFactory()
  {
    return (DroneMainFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(mdEClass, org.roboticiens.idmProject.droneMain.MD.class, "MD", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(gDrEClass, GDr.class, "GDr", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(rgrdEClass, org.roboticiens.idmProject.droneMain.RGRD.class, "RGRD", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(arEClass, org.roboticiens.idmProject.droneMain.AR.class, "AR", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
