 ...
 * </p>
 * <ul>
 *   <li>{@link org.roboticiens.idmProject.droneMain.impl.ReculerImpl#getDuree <em>Duree</em>}</li>
 *   <li>{@link org.roboticiens.idmProject.droneMain.impl.ReculerImpl#getVitesse_deplacement <em>Vitesse deplacement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReculerImpl extends StatementImpl implements Reculer
{
  ...
  {
    return DroneMainPackage.Literals.RECULER;
  }
  ...
  public NotificationChain basicSetDuree(IntExp newDuree, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroneMainPackage.RECULER__DUREE, oldDuree, newDuree);
  ...
  public void setDuree(IntExp newDuree)
  {
    if (newDuree != duree)
    {
      ...
      if (duree != null)
        msgs = ((InternalEObject)duree).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroneMainPackage.RECULER__DUREE, null, msgs);
      if (newDuree != null)
        msgs = ((InternalEObject)newDuree).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroneMainPackage.RECULER__DUREE, null, msgs);
      msgs = basicSetDuree(newDuree, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneMainPackage.RECULER__DUREE, newDuree, newDuree));
  }
  ...
  public NotificationChain basicSetVitesse_deplacement(PourcentExp newVitesse_deplacement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroneMainPackage.RECULER__VITESSE_DEPLACEMENT, oldVitesse_deplacement, newVitesse_deplacement);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setVitesse_deplacement(PourcentExp newVitesse_deplacement)
  {
    if (newVitesse_deplacement != vitesse_deplacement)
    {
      ...
      if (vitesse_deplacement != null)
        msgs = ((InternalEObject)vitesse_deplacement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroneMainPackage.RECULER__VITESSE_DEPLACEMENT, null, msgs);
      if (newVitesse_deplacement != null)
        msgs = ((InternalEObject)newVitesse_deplacement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroneMainPackage.RECULER__VITESSE_DEPLACEMENT, null, msgs);
      msgs = basicSetVitesse_deplacement(newVitesse_deplacement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneMainPackage.RECULER__VITESSE_DEPLACEMENT, newVitesse_deplacement, newVitesse_deplacement));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DroneMainPackage.RECULER__DUREE:
        return basicSetDuree(null, msgs);
      case DroneMainPackage.RECULER__VITESSE_DEPLACEMENT:
