 ...
 * </p>
 * <ul>
 *   <li>{@link org.roboticiens.idmProject.droneMain.impl.Eloignement_maxImpl#getHauteur_max <em>Hauteur max</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Eloignement_maxImpl extends MinimalEObjectImpl.Container implements Eloignement_max
{
  ...
  {
    return DroneMainPackage.Literals.ELOIGNEMENT_MAX;
  }
  ...
  public NotificationChain basicSetHauteur_max(IntExp newHauteur_max, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroneMainPackage.ELOIGNEMENT_MAX__HAUTEUR_MAX, oldHauteur_max, newHauteur_max);
  ...
  public void setHauteur_max(IntExp newHauteur_max)
  {
    if (newHauteur_max != hauteur_max)
    {
      ...
      if (hauteur_max != null)
        msgs = ((InternalEObject)hauteur_max).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroneMainPackage.ELOIGNEMENT_MAX__HAUTEUR_MAX, null, msgs);
      if (newHauteur_max != null)
        msgs = ((InternalEObject)newHauteur_max).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroneMainPackage.ELOIGNEMENT_MAX__HAUTEUR_MAX, null, msgs);
      msgs = basicSetHauteur_max(newHauteur_max, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneMainPackage.ELOIGNEMENT_MAX__HAUTEUR_MAX, newHauteur_max, newHauteur_max));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DroneMainPackage.ELOIGNEMENT_MAX__HAUTEUR_MAX:
