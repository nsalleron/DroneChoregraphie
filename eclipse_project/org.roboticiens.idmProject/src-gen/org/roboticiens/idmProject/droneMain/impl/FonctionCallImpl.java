 ...
 * </p>
 * <ul>
 *   <li>{@link org.roboticiens.idmProject.droneMain.impl.FonctionCallImpl#getFunc <em>Func</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FonctionCallImpl extends MinimalEObjectImpl.Container implements FonctionCall
{
  ...
  {
    return DroneMainPackage.Literals.FONCTION_CALL;
  }
    ...
    if (func != null && func.eIsProxy())
    {
      ...
      if (func != oldFunc)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DroneMainPackage.FONCTION_CALL__FUNC, oldFunc, func));
      }
    }
    return func;
  }
  ...
  public void setFunc(FonctionDecl newFunc)
  {
    ...
    func = newFunc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DroneMainPackage.FONCTION_CALL__FUNC, oldFunc, func));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DroneMainPackage.FONCTION_CALL__FUNC:
